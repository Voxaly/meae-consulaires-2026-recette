...
**[📄 Spécifications publiques VPI - meae_vpi_n_specs_PUBLIQUES-0-11.pdf](https://github.com/Voxaly/meae-consulaires-2026-recette/releases/download/meae-consulaire-4.15.0/meae_vpi_n_specs_PUBLIQUES-0-11.pdf)**

Ce document décrit les spécifications techniques et fonctionnelles du système de vote par internet (VPI).

## Informations de publication

- **Version** : meae-consulaire-4.15.0
- **Date** : 2026-05-07 09:03:57
- **Commit** : 7cffacb5ae
- **Auteur** : jenkins
...
- `app.bundle.js`: `e6008d45359788c3a921d24066105d32d87a934094a2950918b28440c0fb024d`
...
1. **Vérifiez la version :** Assurez-vous de comparer le bon tag Git (meae-consulaire-4.15.0)
